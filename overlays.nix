[
  ( #self: super:
   ...
   in {
    wallpaperengine-steam = self.callPackage ./wallpaper-steam {};
  ...
  # };
      ...
      ffmpeg_3_3_9 = (prev.callPackage (import (prev.path + "/pkgs/development/libraries/ffmpeg/generic.nix") rec {
        version = "3.3.9";
        ...
        in builtins.map (x: builtins.foldl' (x: f: f x) x [
          (disable "cuvid")
          (disable "nvenc")
          (disable "sdl2")
        ]);
      ...
      haskellPackages = prev.haskellPackages.override {
        overrides = self: super: with prev.haskell.lib; {
          ...
          xmobar_0_44_2 = dontCheck (appendPatch (super.callHackageDirect {
            pkg = "xmobar";
            ver = "0.44.2";
          ...
          termonad = appendPatch (super.callHackageDirect {
            pkg = "termonad";
            ver = "4.6.0.0";
